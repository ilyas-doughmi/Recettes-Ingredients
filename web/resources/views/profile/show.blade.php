        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="grid grid-cols-3 gap-8 py-8 border-t border-gray-100 max-w-2xl">
                <div class="text-center md:text-left">
                    <span class="block text-3xl font-extrabold text-gray-900">12</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gradient-to-br from-primary-500 to-orange-600 rounded-3xl shadow-lg p-6 text-white text-center">
                    ...
                    <p class="text-primary-100 mb-6 text-sm">Accédez à des statistiques avancées et mettez en avant vos recettes.</p>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow flex gap-4 border border-gray-100">
                        <img class="w-24 h-24 rounded-xl object-cover" src="https://images.unsplash.com/photo-1546069901-ba9599a7e63c?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80" alt="Recette">
                        <div class="flex-grow flex flex-col justify-between">
                            <div>
                                <div class="flex justify-between items-start">
                                    <h3 class="text-lg font-bold text-gray-900 hover:text-primary-600 cursor-pointer">Salade Fraîcheur d'Été {{ $i }}</h3>
                                ...
                                <p class="text-sm text-gray-500 line-clamp-1 mt-1">Une salade légère et colorée pour les journées chaudes.</p>
                            </div>
                            <div class="flex items-center gap-4 text-sm text-gray-400 mt-2">
                                <span class="flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg> 245 vues</span>
                                <span class="flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg> 12 likes</span>
                                <span class="flex items-center gap-1"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg> 25 Jan 2026</span>
                            </div>
                        </div>
                    </div>
                    @endfor
